...
export async function GET(request) {
  ...
  // Sprawdź, czy token istnieje w tabeli user
  ...
  // Ręczne potwierdzenie konta w Supabase Auth
  ...
  // Usuń token po potwierdzeniu i ustaw verified na true
  await supabaseAdmin
    .from('user')
    .update({ verification_token: null, verified: true })
    .eq('id', userData.id)

  // Przekieruj na stronę zalogowania lub panelu
