  ...
  return (
    <aside className="w-64 bg-transparent p-4 h-full">
      <ul className="flex flex-col space-y-4 text-lg">
        ...
        <li>
          <Link href="/wyniki">
            <button className="relative w-48 h-12 flex items-center justify-center transform transition-transform hover:scale-105 text-white rounded-md bg-gradient-to-tr from-[#3b82f6] to-[#094fc2] hover:from-[v] hover:to-[#3b82f6] overflow-hidden group shadow-[6px_6px_12px_rgba(0,0,0,0.8)] hover:shadow-[10px_10px_18px_rgba(0,0,0,1)]">
